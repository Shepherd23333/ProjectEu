package me.shepherd23333.projecte.api.proxy;
...
public interface IEMCProxy {
     ...
     */
    void registerCustomEMC(@Nonnull ItemStack stack, BigInteger value);
     ...
     */
    void registerCustomEMC(@Nonnull Object o, BigInteger value);
     ...
     */
    BigInteger getValue(@Nonnull Block block);
     ...
     */
    BigInteger getValue(@Nonnull Item item);
     ...
     */
    BigInteger getValue(@Nonnull ItemStack stack);
     ...
     */
    BigInteger getSellValue(@Nonnull ItemStack stack);
}
