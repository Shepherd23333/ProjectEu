package me.shepherd23333.projecte.api;
...
import me.shepherd23333.projecte.api.proxy.IBlacklistProxy;
import me.shepherd23333.projecte.api.proxy.IConversionProxy;
import me.shepherd23333.projecte.api.proxy.IEMCProxy;
import me.shepherd23333.projecte.api.proxy.ITransmutationProxy;
...
public final class ProjectEAPI {
    ...
    public static IEMCProxy getEMCProxy() {
        if (emcProxy == null) {
            try {
                Class<?> clazz = Class.forName("me.shepherd23333.projecte.impl.EMCProxyImpl");
    ...
    public static IConversionProxy getConversionProxy() {
        if (recipeProxy == null) {
            try {
                Class<?> clazz = Class.forName("me.shepherd23333.projecte.impl.ConversionProxyImpl");
    ...
    public static ITransmutationProxy getTransmutationProxy() {
        if (transProxy == null) {
            try {
                Class<?> clazz = Class.forName("me.shepherd23333.projecte.impl.TransmutationProxyImpl");
    ...
    public static IBlacklistProxy getBlacklistProxy() {
        if (blacklistProxy == null) {
            try {
                Class<?> clazz = Class.forName("me.shepherd23333.projecte.impl.BlacklistProxyImpl");
